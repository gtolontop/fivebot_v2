      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        <div className="mt-6 sm:mt-8">
          <button
            ...
            className="group relative w-full flex justify-center items-center py-3 sm:py-3.5 px-4 border border-transparent text-sm sm:text-base font-medium rounded-md text-white bg-discord-500 hover:bg-discord-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-discord-500 transition-colors"
          >
