    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage your account information and profile</p>
        </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 mt-1">
                      Your account is linked to Discord. Username and email are automatically synced.
                    </p>
                  </div>
                </div>
              </div>
