                ...
                {closedTickets.length > 0 ? (
                  <div className="space-y-3">
                    {closedTickets.map((ticket) => (
                      <div key={ticket.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow bg-gray-50">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-1">
                              <span className="text-sm font-semibold text-gray-900">Ticket #{ticket.ticketNumber}</span>
                              <span className="px-2 py-0.5 text-xs font-medium bg-gray-200 text-gray-700 rounded">
                                Closed
                              </span>
                            </div>
                            <p className="text-sm text-gray-600 mb-2">{ticket.description || 'No description'}</p>
                            <div className="flex items-center space-x-4 text-xs text-gray-500">
                              <span>Created by: {ticket.creatorId}</span>
                  ...
                  <div className="text-center p-8 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Closed tickets will appear here</p>
                  </div>
                )}
              </div>
            )}
